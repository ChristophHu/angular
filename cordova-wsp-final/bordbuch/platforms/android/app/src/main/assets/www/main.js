...
const icons = {
    ...
    'identification': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /></svg>`,
    'information-circle': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
    ...
    'minus': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20 12H4" /></svg>`,
    'minus-circle': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
    'minus-sm': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6" /></svg>`,
    ...
    'question-mark': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 8a3.5 3 0 0 1 3.5 -3h1a3.5 3 0 0 1 3.5 3a3 3 0 0 1 -2 3a3 4 0 0 0 -2 4" /><line x1="12" y1="19" x2="12" y2="19.01" /></svg>`,
    'question-mark-round': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`,
...
/* harmony import */ var _shared_components_error_error_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/components/error/error.component */ 93772);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
...
const routes = [
    ...
    { path: 'error', component: _shared_components_error_error_component__WEBPACK_IMPORTED_MODULE_1__.ErrorComponent }
];
...
class ErrorInterceptor {
    ...
    intercept(req, next) {
        ...
        return next.handle(req).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.retry)(2), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)((error) => {
            let errorObj;
            if (errorObj instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpErrorResponse) {
                if (errorObj.status === 0) {
                    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)('Unable to Connect to the Server');
                }
            }
            if (error.status !== 401) {
...
ErrorInterceptor.ɵfac = function ErrorInterceptor_Factory(t) { return new (t || ErrorInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__.Router)); };
...
/* harmony import */ var _connection_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./connection.service */ 45684);
/* harmony import */ var _location_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./location.service */ 33094);
...
class AppService {
    constructor(httpClient, store, _connectionService, locationService) {
        ...
        // position
        this._positionSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_4__.Subscription;
        this.positionLogInterval = (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.interval)(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.positionLogInterval * (60 * 1000));
        this.store.pipe((0,_ngrx_store__WEBPACK_IMPORTED_MODULE_6__.select)(src_app_modules_auth_state_selectors__WEBPACK_IMPORTED_MODULE_0__.selectToken)).subscribe(token => {
            this._connectionService.setToken(token);
        });
        this.store.pipe((0,_ngrx_store__WEBPACK_IMPORTED_MODULE_6__.select)(src_app_modules_auth_state_selectors__WEBPACK_IMPORTED_MODULE_0__.selectBackendUrl)).subscribe(backendUrl => {
    ...
    updateZaehlerstand(zaehlerstand) {
...
AppService.ɵfac = function AppService_Factory(t) { return new (t || AppService)(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_9__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_6__.Store), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_connection_service__WEBPACK_IMPORTED_MODULE_2__.ConnectionService), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_location_service__WEBPACK_IMPORTED_MODULE_3__.LocationService)); };
AppService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjectable"]({ token: AppService, factory: AppService.ɵfac, providedIn: 'root' });
...
class LoginComponent {
  constructor(dialog, _formBuilder, store, router, authService, modalService) {
    this.dialog = dialog;
  ...
  login() {
    ...
    })).subscribe(rxjs__WEBPACK_IMPORTED_MODULE_10__.noop, error => {
...
LoginComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
  ...
  template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵtext"](24, "Aktualisierung 27.03.2022");
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementEnd"]();
    }
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵadvance"](1);
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵpropertyInterpolate"]("name", ctx.hide ? "eye-off" : "eye");
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵadvance"](1);
  ...
  directives: [src_app_shared_components_splash_screen_splash_screen_component__WEBPACK_IMPORTED_MODULE_5__.SplashScreenComponent, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormGroupDirective, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__.MatFormField, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__.MatLabel, _angular_material_input__WEBPACK_IMPORTED_MODULE_15__.MatInput, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControlName, _angular_common__WEBPACK_IMPORTED_MODULE_16__.NgIf, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__.MatSuffix, _projects_icon_library_src_lib_icon_library_component__WEBPACK_IMPORTED_MODULE_6__.IconLibraryComponent, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__.MatError],
...
ErrorDialog.ɵfac = function ErrorDialog_Factory(t) {
  return new (t || ErrorDialog)(_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MatDialogRef), _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MAT_DIALOG_DATA));
};

ErrorDialog.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
  type: ErrorDialog,
  selectors: [["error-dialog"]],
  decls: 4,
  vars: 1,
  consts: [["mat-dialog-title", "", 1, "text-xl", "font-bold"], ["mat-dialog-content", ""]],
  template: function ErrorDialog_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementStart"](0, "h1", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵtext"](1, "Fehler in der Anmeldung");
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementEnd"]();
      _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵelementStart"](2, "div", 1);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ToggleEnum": () => (/* binding */ ToggleEnum),
/* harmony export */   "ButtonToggleGroupComponent": () => (/* binding */ ButtonToggleGroupComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/material/button-toggle */ 42542);


var ToggleEnum;
(function (ToggleEnum) {
    ToggleEnum[ToggleEnum["Option1"] = 0] = "Option1";
    ToggleEnum[ToggleEnum["Option2"] = 1] = "Option2";
    ToggleEnum[ToggleEnum["Option3"] = 2] = "Option3";
})(ToggleEnum || (ToggleEnum = {}));
class ButtonToggleGroupComponent {
    constructor() {
        this.toggleEnum = ToggleEnum;
        this.selectedState = ToggleEnum.Option3;
    }
    onChange($event) {
...
ButtonToggleGroupComponent.ɵfac = function ButtonToggleGroupComponent_Factory(t) { return new (t || ButtonToggleGroupComponent)(); };
ButtonToggleGroupComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ButtonToggleGroupComponent, selectors: [["app-button-toggle-group"]], decls: 5, vars: 3, consts: [[3, "value", "change"], [3, "value"]], template: function ButtonToggleGroupComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-button-toggle-group", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ButtonToggleGroupComponent_Template_mat_button_toggle_group_change_0_listener($event) { return ctx.onChange($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-button-toggle", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Klar");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "mat-button-toggle", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Unklar");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", ctx.selectedState);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", ctx.toggleEnum.Option1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", ctx.toggleEnum.Option2);
    } }, directives: [_angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_1__.MatButtonToggleGroup, _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_1__.MatButtonToggle], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJidXR0b24tdG9nZ2xlLWdyb3VwLmNvbXBvbmVudC5zYXNzIn0= */"] });
...
ErrorComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ErrorComponent, selectors: [["app-error"]], decls: 5, vars: 0, consts: [["routerLinkActive", "active-link", 1, "btn", 3, "click"], [1, "text-base", "leading-4"]], template: function ErrorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "error works!");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "button", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ErrorComponent_Template_button_click_2_listener() { return ctx.tologin(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "p", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Login");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, styles: [".btn[_ngcontent-%COMP%] {\n    display: flex;\n    width: 100%;\n    align-items: center;\n    justify-content: flex-start\n}\n.btn[_ngcontent-%COMP%]    > [_ngcontent-%COMP%]:not([hidden])    ~ [_ngcontent-%COMP%]:not([hidden]) {\n    --tw-space-x-reverse: 0;\n    margin-right: calc(1.5rem * var(--tw-space-x-reverse));\n    margin-left: calc(1.5rem * calc(1 - var(--tw-space-x-reverse)))\n}\n.btn[_ngcontent-%COMP%] {\n    border-radius: 0.25rem;\n    padding-top: 0.75rem;\n    padding-bottom: 0.75rem;\n    padding-left: 1rem;\n    --tw-text-opacity: 1;\n    color: rgba(31, 41, 55, var(--tw-text-opacity))\n}\n.btn[_ngcontent-%COMP%]:hover {\n    --tw-bg-opacity: 1;\n    background-color: rgba(59, 130, 246, var(--tw-bg-opacity));\n    --tw-text-opacity: 1;\n    color: rgba(255, 255, 255, var(--tw-text-opacity))\n}\n.btn[_ngcontent-%COMP%]:focus {\n    --tw-bg-opacity: 1;\n    background-color: rgba(59, 130, 246, var(--tw-bg-opacity));\n    --tw-text-opacity: 1;\n    color: rgba(255, 255, 255, var(--tw-text-opacity));\n    outline: 2px solid transparent;\n    outline-offset: 2px\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
ImageSliderComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: ImageSliderComponent, selectors: [["app-image-slider"]], inputs: { images: "images" }, decls: 10, vars: 7, consts: [[1, "fixed", "z-50", "inset-0", "overflow-hidden"], [1, "min-h-screen", "bg-gray-800", "bg-opacity-90", 3, "click"], [1, "absolute", "top-8", "right-4", "bottom-4", "left-4", "bg-white", "rounded"], [1, "h-16", "p-8", "flex", "items-center", "justify-between", "border-b"], ["tabindex", "0", 1, "dark:text-gray-50", "focus:outline-none", "text-2xl", "font-semibold", "leading-6", "text-gray-800"], [1, "w-6", "h-6", "focus:outline-none", "rounded-md", "cursor-pointer", 3, "click"], ["name", "x", 1, "w-6", "h-6", "stroke-2", "stroke-current", "text-gray-500"], [1, "p-4", "w-full"], [3, "images", "objectFit", "cellWidth", "height", "autoplay", "dots", "loop"]], template: function ImageSliderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](5, " Pr\u00FCfvermerk Bilder ");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
...
/***/ 3919:
/*!********************************************************************!*\
  !*** ./src/app/shared/directives/simpleSticky/sticky.directive.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StickyDirective": () => (/* binding */ StickyDirective)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ 38583);
...
class StickyDirective {
    constructor(document, platformId, stickyElement) {
    ...
    setHTMLElement(prop, value) {
        if (typeof value === 'string') {
            this['_scrollContainer'] = this.document.getElementById(value);
        }
        else if (value instanceof _angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef) {
    ...
    makeSticky() {
        const nativeElement = this.stickyElement.nativeElement;
    ...
    setStylePropertyToElement(nativeEl, property, value) {
        nativeEl.style[property.toString()] = value;
    }
}
StickyDirective.ɵfac = function StickyDirective_Factory(t) { return new (t || StickyDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.PLATFORM_ID), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ElementRef)); };
StickyDirective.ɵdir = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: StickyDirective, selectors: [["", "sticky", ""]], inputs: { scrollContainer: "scrollContainer", zIndex: "zIndex", top: "top" } });
...
/***/ 17590:
/*!***************************************************************************!*\
  !*** ./src/app/shared/directives/sticky-header/sticky-thing.directive.ts ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StickyThingDirective": () => (/* binding */ StickyThingDirective)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 37716);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 54857);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ 9112);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs */ 34022);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 93137);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ 78345);
...
class StickyThingDirective {
    constructor(stickyElement, platformId) {
        ...
        this.marginTop$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(0);
        this.marginBottom$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(0);
        this.enable$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(true);
        this.auditTime = 0;
        this.sticky = false;
        this.isSticky = false;
        this.boundaryReached = false;
        this.upperBoundReached = false;
        this.stickyStatus = new _angular_core__WEBPACK_IMPORTED_MODULE_1__.EventEmitter();
        this.stickyPosition = new _angular_core__WEBPACK_IMPORTED_MODULE_1__.EventEmitter();
        /**
        ...
        this.extraordinaryChange$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(undefined);
        ...
        this.scrollThrottled$ = this.scroll$
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.throttleTime)(0, rxjs__WEBPACK_IMPORTED_MODULE_4__.animationFrameScheduler), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)());
        /**
         * Throttle the resize to animation frame (around 16.67ms) */
        this.resizeThrottled$ = this.resize$
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.throttleTime)(0, rxjs__WEBPACK_IMPORTED_MODULE_4__.animationFrameScheduler), 
        // emit once since we are currently using combineLatest
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.startWith)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)());
        this.status$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.combineLatest)(this.enable$, this.scrollThrottled$, this.marginTop$, this.marginBottom$, this.extraordinaryChange$, this.resizeThrottled$).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.filter)(([enabled]) => this.checkEnabled(enabled)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(([enabled, pageYOffset, marginTop, marginBottom]) => this.determineStatus(this.determineElementOffsets(), pageYOffset, marginTop, marginBottom, enabled)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)());
    }
    set marginTop(value) {
    ...
    ngAfterViewInit() {
        const operators = this.scrollContainer ?
            (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.pipe)((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.takeUntil)(this.componentDestroyed)) :
            (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.pipe)((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.auditTime)(this.auditTime), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.takeUntil)(this.componentDestroyed));
        this.status$
            .pipe(operators)
            .subscribe((status) => {
    ...
    makeSticky(boundaryReached = false, marginTop, marginBottom) {
        ...
        let offSet = 0;
        if (this.boundaryElement != undefined) {
            offSet = boundaryReached ? (this.getComputedStyle(this.boundaryElement).bottom - height - this.marginBottom$.value) : this.marginTop$.value;
        }
    ...
    checkSetup() {
        if ((0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.isDevMode)() && !this.spacerElement) {
...
StickyThingDirective.ɵfac = function StickyThingDirective_Factory(t) { return new (t || StickyThingDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.ElementRef), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.PLATFORM_ID)); };
StickyThingDirective.ɵdir = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({ type: StickyThingDirective, selectors: [["", "stickyThing", ""]], hostVars: 6, hostBindings: function StickyThingDirective_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("resize", function StickyThingDirective_resize_HostBindingHandler() { return ctx.onWindowResize(); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵresolveWindow"]);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵclassProp"]("is-sticky", ctx.isSticky)("boundary-reached", ctx.boundaryReached)("upper-bound-reached", ctx.upperBoundReached);
...
class OrderByPipe {
    transform(input, byProperty = 'id', order = 'ASC') {
...
/***/ 87448:
/*!*******************************************************************!*\
  !*** ./src/app/shared/pipes/sanitize-html2/sanitize-html.pipe.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SanitizeHtmlPipe2": () => (/* binding */ SanitizeHtmlPipe2)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/platform-browser */ 39075);


class SanitizeHtmlPipe2 {
    constructor(_sanitizer) {
        this._sanitizer = _sanitizer;
    }
    transform(value) {
...
SanitizeHtmlPipe2.ɵfac = function SanitizeHtmlPipe2_Factory(t) { return new (t || SanitizeHtmlPipe2)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__.DomSanitizer, 16)); };
SanitizeHtmlPipe2.ɵpipe = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "sanitizeHtml2", type: SanitizeHtmlPipe2, pure: true });
...
/***/ 97379:
/*!***************************************************************************!*\
  !*** ./src/app/shared/pipes/sliceArrayByProperty/sliceArrayByProperty.ts ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SliceArrayByPropertyPipe": () => (/* binding */ SliceArrayByPropertyPipe)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 37716);

class SliceArrayByPropertyPipe {
    transform(input, byProperty, value = '') {
...
SliceArrayByPropertyPipe.ɵfac = function SliceArrayByPropertyPipe_Factory(t) { return new (t || SliceArrayByPropertyPipe)(); };
SliceArrayByPropertyPipe.ɵpipe = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "sliceArrayByProperty", type: SliceArrayByPropertyPipe, pure: true });
...
/* harmony import */ var _directives_sticky_header_sticky_thing_directive__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./directives/sticky-header/sticky-thing.directive */ 17590);
/* harmony import */ var _pipes_order_by_order_by_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./pipes/order-by/order-by.pipe */ 44264);
/* harmony import */ var _pipes_sliceArrayByProperty_sliceArrayByProperty__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pipes/sliceArrayByProperty/sliceArrayByProperty */ 97379);
/* harmony import */ var _components_button_toggle_group_button_toggle_group_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/button-toggle-group/button-toggle-group.component */ 70431);
/* harmony import */ var _directives_simpleSticky_sticky_directive__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./directives/simpleSticky/sticky.directive */ 3919);
/* harmony import */ var _pipes_sanitize_html2_sanitize_html_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pipes/sanitize-html2/sanitize-html.pipe */ 87448);
...
SharedModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵdefineInjector"]({ imports: [[
        ...
        _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_31__.MatButtonToggleModule,
        _directives_info_popup_info_popup_module__WEBPACK_IMPORTED_MODULE_14__.InfoPopupModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_21__["ɵɵsetNgModuleScope"](SharedModule, { declarations: [_components_progress_bar_progress_bar_component__WEBPACK_IMPORTED_MODULE_4__.ProgressBarComponent,
        ...
        _directives_sticky_header_sticky_thing_directive__WEBPACK_IMPORTED_MODULE_15__.StickyThingDirective,
        _directives_simpleSticky_sticky_directive__WEBPACK_IMPORTED_MODULE_19__.StickyDirective,
        ...
        _pipes_order_by_order_by_pipe__WEBPACK_IMPORTED_MODULE_16__.OrderByPipe,
        _pipes_sliceArrayByProperty_sliceArrayByProperty__WEBPACK_IMPORTED_MODULE_17__.SliceArrayByPropertyPipe,
        _components_button_toggle_group_button_toggle_group_component__WEBPACK_IMPORTED_MODULE_18__.ButtonToggleGroupComponent,
        _pipes_sanitize_html2_sanitize_html_pipe__WEBPACK_IMPORTED_MODULE_20__.SanitizeHtmlPipe2], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_22__.CommonModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormsModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_23__.ReactiveFormsModule,
        // shared
        _components_modal_modal_module__WEBPACK_IMPORTED_MODULE_0__.ModalModule,
        ...
        _pipes_order_by_order_by_pipe__WEBPACK_IMPORTED_MODULE_16__.OrderByPipe,
        _pipes_sliceArrayByProperty_sliceArrayByProperty__WEBPACK_IMPORTED_MODULE_17__.SliceArrayByPropertyPipe,
        _pipes_sanitize_html2_sanitize_html_pipe__WEBPACK_IMPORTED_MODULE_20__.SanitizeHtmlPipe2,
        _angular_common__WEBPACK_IMPORTED_MODULE_22__.CommonModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_23__.FormsModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_23__.ReactiveFormsModule,
        // shared
...
/* harmony export */   "loadLastPositions": () => (/* binding */ loadLastPositions),
/* harmony export */   "loadLastPositionsSuccess": () => (/* binding */ loadLastPositionsSuccess),
...
/* harmony export */   "loadAllShipSuccess": () => (/* binding */ loadAllShipSuccess),
...
// lastpositions
const loadLastPositions = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_0__.createAction)("[Kat Resolver] Load LastPosition");
const loadLastPositionsSuccess = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_0__.createAction)("[Load Kat Effect] Loaded LastPosition", (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_0__.props)());
// pruefvermerke
...
const loadAllShipSuccess = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_0__.createAction)("[Load Kat Effect] Ships Loaded", (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_0__.props)());
// status
...
class Effects {
    constructor(actions$, appService) {
        ...
        this.loadAllShip$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.ofType)(_actions__WEBPACK_IMPORTED_MODULE_0__.loadAllShip), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(action => this.appService.getSchiffe()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)((shipSelection) => (0,_actions__WEBPACK_IMPORTED_MODULE_0__.loadAllShipSuccess)({ shipSelection })));
        });
        this.loadLastPositions$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.ofType)(_actions__WEBPACK_IMPORTED_MODULE_0__.loadLastPositions), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(action => this.appService.getLastPositionsFromAllShips()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)((lastPositions) => (0,_actions__WEBPACK_IMPORTED_MODULE_0__.loadLastPositionsSuccess)({ lastPositions })));
        });
        ...
        this.loadBetriebsstoffe$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__.ofType)(_actions__WEBPACK_IMPORTED_MODULE_0__.loadBetriebsstoffe), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(action => this.appService.getBetriebsstoffe()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)((betriebsstoffe) => (0,_actions__WEBPACK_IMPORTED_MODULE_0__.loadedBetriebsstoffe)({ betriebsstoffe })));
        });
...
const reducer = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.createReducer)(initialDataState, (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.on)(_actions__WEBPACK_IMPORTED_MODULE_0__.loadAllShipSuccess, (state, action) => {
    return Object.assign(Object.assign({}, state), { shipSelection: action.shipSelection });
}), (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_1__.on)(_actions__WEBPACK_IMPORTED_MODULE_0__.loadLastPositionsSuccess, (state, action) => {
    return Object.assign(Object.assign({}, state), { lastPositions: action.lastPositions });
