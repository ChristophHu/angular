(self["webpackChunkbordbuch_wsp_final"] = self["webpackChunkbordbuch_wsp_final"] || []).push([["default-src_app_core_navbar_tabbar_tabbar_module_ts-src_app_store_kat-store_index_ts-src_app_-325b99"],{
        ...
        return this.store.pipe((0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.select)(_store_selectors__WEBPACK_IMPORTED_MODULE_1__.isKatLoaded), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)((isKatLoaded) => {
            if (!this.loading && !isKatLoaded) {
                ...
                setTimeout(() => {
                    ...
                    this.store.dispatch(___WEBPACK_IMPORTED_MODULE_0__.KatAction.loadLastPositions());
...
class ShipEffects {
    constructor(actions$, appService) {
        ...
        this.updateShip$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__.ofType)(___WEBPACK_IMPORTED_MODULE_0__.ShipAction.updateShip), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(action => {
                return this.appService.updateSchiff(action.update).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => ___WEBPACK_IMPORTED_MODULE_0__.ShipAction.updateShipSuccess({ update: action.update })));
            }));
        });
        ...
        this.updatePatrol$ = (0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__.createEffect)(() => {
            return this.actions$.pipe((0,_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__.ofType)(___WEBPACK_IMPORTED_MODULE_0__.ShipAction.updatePatrol), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(action => {
                return this.appService.updateStreife(action.update).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => ___WEBPACK_IMPORTED_MODULE_0__.ShipAction.updatePatrolSuccess({ action })));
            }));
        });
...
const shipReducer = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createReducer)(initialDataState, (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.on)(___WEBPACK_IMPORTED_MODULE_1__.ShipAction.shipLoaded, (state, action) => {
...
}), (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.on)(___WEBPACK_IMPORTED_MODULE_1__.ShipAction.updateShipSuccess, (state, action) => {
    return Object.assign(Object.assign({}, state), { ship: action.update });
    ...
    return Object.assign(Object.assign({}, state), { patrol: patrol });
}), (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.on)(___WEBPACK_IMPORTED_MODULE_1__.ShipAction.updatePatrolSuccess, (state, action) => {
    let patrol = action.action.update;
    return Object.assign(Object.assign({}, state), { patrol: patrol });
...
}), (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.on)(___WEBPACK_IMPORTED_MODULE_1__.ShipAction.updateReparaturSuccess, (state, action) => {
    var _a;
    let cleared = (_a = state.reparaturen) === null || _a === void 0 ? void 0 : _a.filter(el => el.id != action.update.id);
    let pruefvermerk = Object.assign({}, action.update);
    cleared = [...cleared, ...[pruefvermerk]];
    return Object.assign(Object.assign({}, state), { reparaturen: cleared });
}), 
//peilungen
...
//# sourceMappingURL=default-src_app_core_navbar_tabbar_tabbar_module_ts-src_app_store_kat-store_index_ts-src_app_-325b99.js.map