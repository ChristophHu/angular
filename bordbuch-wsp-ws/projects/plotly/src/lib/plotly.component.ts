...
export class PlotlyComponent implements OnInit, OnChanges, OnDestroy, DoCheck {
    ...
    public plotlyInstance: Plotly.PlotlyHTMLElement | undefined
    public resizeHandler?: (instance: Plotly.PlotlyHTMLElement) => void;
    public layoutDiffer: KeyValueDiffer<string, any> | undefined
    public dataDiffer: IterableDiffer<Plotly.Data> | undefined
