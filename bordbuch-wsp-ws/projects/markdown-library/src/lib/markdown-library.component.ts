...
export class MarkdownLibraryComponent implements OnChanges, AfterViewInit {
  ...
  constructor(
    ...
    public markdownLibraryService: MarkdownLibraryService,
  ) { }
  ...
  render(markdown: string, decodeHtml = false): void {
    let compiled = this.markdownLibraryService.compile(markdown, decodeHtml, this.emoji)
    this.element.nativeElement.innerHTML = compiled
    this.handlePlugins()
    this.markdownLibraryService.highlight(this.element.nativeElement)
    this.ready.emit()
  }
