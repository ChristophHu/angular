...
@Component({
  ...
  styleUrls: ['./multi-line-chart.component.sass'],
...
export class MultiLineChartComponent implements OnInit {
  ...
  title = 'Multi-Series Line Chart';
    ...
    ngOnInit() {
        ...
        this.data = TEMPERATURES.map((v: any) => v.values.map((v: any) => v.date ))[0];
    ...
    private initChart(): void {
        ...
        this.z.domain(TEMPERATURES.map(function(c: any) { return c.id; }));
    }
