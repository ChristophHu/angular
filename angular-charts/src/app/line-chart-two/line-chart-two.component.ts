...
@Component({
  ...
  styleUrls: ['./line-chart-two.component.sass']
})
export class LineChartTwoComponent implements AfterViewInit {
  ...
  private generateData(n: any, maxValue: any) {
