...
export class StickyThingDirective implements OnInit, AfterViewInit, OnDestroy {
  ...
  private status$: Observable<StickyStatus | any>;
  ...
  private determineBoundaryReached(boundaryHeight: number, stickyElHeight: number, cssMargins: any, marginTop: number, marginBottom: number, upperScreenEdgeAt: number) {
